...
public class AppointmentController {
    ...
    @PostMapping("")
    ResponseEntity<String> bookAppointment(@RequestBody Appointment appointment) throws InvalidInputException, SlotUnavailableException {
        String savedAppointmentId = appointmentService.appointment(appointment);
        return ResponseEntity.ok().body(savedAppointmentId);
    }


    //create a get method named getAppointment with return type as getAppointment
    ...
    ResponseEntity<Appointment> getAppointment(@PathVariable("appointmentId") String appointmentId) {
